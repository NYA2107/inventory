 ...
 * @author dimashv
 */
public class UserAsetView extends javax.swing.JFrame {
     ...
     */
    public UserAsetView(int idBarang) {
        initComponents();
...
//            jDateChooser2.setDate(record.tanggal_akhir_kontrak);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserAsetView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserAsetView().setVisible(true);
            }
        });
    }
