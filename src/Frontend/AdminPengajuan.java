 ...
 * @author dimashv
 */
public class AdminPengajuan extends javax.swing.JFrame {
    ...
    public void selectData() {
        String kolom[] = {"ID", "Nopol", "Merk", "Pihak 1"};
        ...
        TablePengajuan.setModel(dtm);
            ...
            Logger.getLogger(AdminPengajuan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Manajemen Pengajuan");
...
//            System.out.println("masuk");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        AdminRiwayatView fa = new AdminRiwayatView(selected, "pengajuan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPengajuan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminPengajuan().setVisible(true);
            }
        });
    }
